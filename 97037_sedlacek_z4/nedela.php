...
$delikanti = get_object_vars($arr[6]);
$json = file_get_contents('./storage/eat.json');
$arr = json_decode($json);
$eat = get_object_vars($arr[6]);
$json = file_get_contents('./storage/fiit.json');
$arr = json_decode($json);
$fiit = get_object_vars($arr[6]);
//var_dump($delikanti);
//var_dump($fiit);
...
<div class="container">
    ...
    <div class="restaurant">
        ...
        <div>Dnes nie je v ponuke ziadne jedlo</div>

    </div>
    <h2>FIIT Food</h2>
    <div class="restaurant">

        <div class="fiit">Dnes nie je v ponuke ziadne jedlo</div>
